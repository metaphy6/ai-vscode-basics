...
Domain terms used across this repo. One line each. Keep alphabetic.

> Copy to `docs/project/GLOSSARY.md`.
...
| Tracking row | One line in `ai/tracking.csv` recording an agent action. |
