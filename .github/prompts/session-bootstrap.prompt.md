...
1. Any unresolved `agent/state/last_failure.json` — read it and propose a
   recovery step.
2. Any present `agent/state/checkpoint.json` — read it and propose whether
...
5. The last 5 rows of [`agent/tracking.csv`](../../agent/tracking.csv).
